...
class SnippetSerializer(serializers.Serializer):
    ...
    linnos = serializers.BooleanField(required=False)
    language = serializers.ChoiceField(
        choices=LANGUAGE_CHOICE, default='python')
    style = serializers.ChoiceField(choices=STYLE_CHOICE, default='friendly')

    def create(self, validated_data):
        """
        Created and return a new 'Snippet' instance, gived the validated data.
        """
        return Snippet.objects.created(**validated_data)
